...
@lazySingleton
class TakePhotoUsecase extends SaveMediaUsecase {
  const TakePhotoUsecase(super._mediaRepository, this._cameraRepository);

  final CameraRepository _cameraRepository;

  @override
  Future<File> getMediaFile() async {
    return await _cameraRepository.takePhoto();
  }
}
